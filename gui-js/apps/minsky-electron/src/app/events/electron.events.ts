...
import { modIpcHandlers } from '../../../../../libs/shared/src/lib/modding/mod-config.backend.generated';

//const logUpdateEvent = debug('minsky:electron_update_event');

export default class ElectronEvents {
    static bootstrapElectronEvents(): Electron.IpcMain {
        // [MODDING] Register Mod IPC Handlers
        modIpcHandlers.forEach(h => {
            console.log(`[Modding] Registering IPC handle: ${h.channel}`);
            ipcMain.handle(h.channel, h.handler);
        });
...
// [MODDING] This core handler is replaced by mod-scenario-loader via Zero Touch Registry
